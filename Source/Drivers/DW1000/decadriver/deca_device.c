 ...
 */
uint8_t dwt_convertdegtemptoraw(int16 externaltemp)
{
    int32 raw_temp;
#ifdef DWT_API_ERROR_CHECK
    assert(pdw1000local->otp_mask & DWT_READ_OTP_TMP);
 ...
 */
uint8_t dwt_convertvoltstoraw(int32 externalmvolt)
{
 ...
 */
uint32_t _dwt_computetxpowersetting(uint32_t ref_powerreg, int32 power_adj)
{
