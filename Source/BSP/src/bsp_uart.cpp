...
SerialConfig usart1_info = {.baudrate = 115200,
                              .gpio_port = GPIOD,
                              .tx_pin = GPIO_PIN_5,
                              .rx_pin = GPIO_PIN_6,
                              .usart_periph = USART1,
...
SerialConfig uart1_config = {.baudrate = 115200,
                             .gpio_port = GPIOD,
                             .tx_pin = GPIO_PIN_5,
                             .rx_pin = GPIO_PIN_6,
                             .usart_periph = USART1,
...
void UART_DMA_Handler::setup() {
    UART_DMA_Handler::init();
    UART_DMA_Handler::dma_tx_config();
    UART_DMA_Handler::idle_dma_rx_config();
}

void UART_DMA_Handler::init() {
...
void UART_DMA_Handler::dma_tx_config() {
...
void UART_DMA_Handler::idle_dma_rx_config() {
    dma_single_data_parameter_struct dma_init_struct;
