...
class ClipInterface {
   public:
    ...
    uint16_t clipIORead() { return clipStatRead(0x01); }
    bool clipLedWrite(uint16_t data) { return clipStatWrite(0x01, 0x01, data); }
    bool clipModeLock() { return clipStatWrite(0x01, 0x02, 0); }
    bool clipModeUnlock() { return clipStatWrite(0x01, 0x02, 0x01); }
    bool clipModeClear() { return clipStatWrite(0x01, 0x02, 0x02); }
