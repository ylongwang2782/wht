...
void CondCfgMsg::process() { Log.d("CondCfgMsg", "process"); }
...
void AnnounceMsg::process() { Log.d("AnnounceMsg", "process"); }

void ShortIdConfirmMsg::process() { Log.d("ShortIdConfirmMsg", "process"); }
}    // namespace Slave2Master

namespace Backend2Master {
void SlaveCfgMsg::process() { Log.d("SlaveCfgMsg", " process"); }

void ModeCfgMsg::process() { Log.d("ModeCfgMsg", "process"); }

void RstMsg::process() { Log.d("RstMsg", "process"); }

void CtrlMsg::process() { Log.d("CtrlMsg", "process"); }
...
void CondDataMsg::process() { Log.d("CondDataMsg", "process"); }

void ResDataMsg::process() { Log.d("ResDataMsg", "process"); }

void ClipDataMsg::process() { Log.d("ClipDataMsg", "process"); }
